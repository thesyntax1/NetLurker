...
AppPublisherURL=https://github.com/thesyntax11/NetLurker
AppSupportURL=https://github.com/thesyntax11/NetLurker/issues
DefaultDirName={autopf}\NetLurker
...
begin
  ...
  begin
    if MsgBox('Also delete NetLurker caches and settings?' + #13#10 +
